                        ...
                        <div class="card-body">
                            <form action="{{ route('updateDepartment', $department->id) }}" method="POST" >
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control rounded-lg" id="name" name="name" value="{{ $department->name }}" placeholder="Enter Name of Department">
                                    @error('name')
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea name="description" class="form-control rounded-lg" id="description" placeholder="Write description...">{{ $department->description }}</textarea>
                                </div>
