                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('saveUser') }}" method="POST">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="name" class="form-control rounded-lg" id="name" placeholder="Enter Full Name" required>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="email" name="email" class="form-control rounded-lg" id="email" placeholder="Enter email address" required>
                                </div>

                                <!-- Password Field -->
                                <div class="mb-5">
                                    <label for="password" class="inline-block font-semibold text-neutral-600 dark:text-neutral-200 text-sm mb-2">
                                        Password <span class="text-danger-600">*</span>
                                    </label>
                                    <input type="password" name="password" class="form-control rounded-lg" id="password" placeholder="Enter password" required>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="phone" class="form-control rounded-lg" id="phone" placeholder="Enter phone number">
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="role" value="admin" class="form-radio" {{ old('role') == 'admin' ? 'checked' : '' }}>
                                            <span class="ml-2 p-2">Admin</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="role" value="employee" class="form-radio" {{ old('role') == 'employee' ? 'checked' : '' }}>
                                            <span class="ml-2 p-2">Employee</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="role" value="user" class="form-radio" {{ old('role') == 'user' ? 'checked' : '' }}>
