        ...
        <div class="col-span-12">
            <div class="card h-full p-0 rounded-xl border-0 overflow-hidden">
                <div class="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 py-4 px-6 flex items-center flex-wrap gap-3 justify-between">
                    ...
                    <a href="{{ route('addPreRegister') }}" class="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2">
                        <iconify-icon icon="ic:baseline-plus" class="icon text-xl line-height-1"></iconify-icon>
                        Pre-register a Visitor now
                    </a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('viewVisitor', $visitor->id) }}" type="button"
                                            ...
                                            <a type="button" href="{{ route('editPreRegister', $visitor->id) }}"
                                            ...
                                            <a type="button" href="{{ route('deletePreRegister', $visitor->id) }}"
                                                ...
                                                onclick="confirmDelete(event, '{{ route('deletePreRegister', $visitor->id) }}')">
