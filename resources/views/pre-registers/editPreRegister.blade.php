...
@php
    $title='Edit Pre-registered Visitor';
    $subTitle = 'Edit Pre-registered Visitor';
@endphp
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 justify-center">
                <div class="col-span-12 lg:col-span-10 xl:col-span-8 2xl:col-span-6 2xl:col-start-4">
                    <div class="card border border-neutral-200 dark:border-neutral-600">
                        <div class="card-body">
                        <form action="{{ route('updatePreRegister', $visitor->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="date" class="form-control rounded-lg" value="{{ old('expected_date', $visitor->expected_date) }}" id="expected_date" name="expected_date" placeholder="Enter Expected Date">
                                    @error('expected_date')
                                        <span class="text-danger-600">{{ $message }}</span>
                                    @enderror
                                </div> 
                                <div class="mb-5">
                                    ...
                                    <input type="time" class="form-control rounded-lg" value="{{ old('expected_time', $visitor->expected_time) }}" id="expected_time" name="expected_time" placeholder="Enter Expected Time">
                                    @error('expected_time')
                                        <span class="text-danger-600">{{ $message }}</span>
                                    @enderror
                                </div>
